    ...
    withOverviewModule(module => {
      ...
      const { markup, ariaLabel } = helper({
        ...
        aggregation: {
          ...
          purchase_value_cents: 123450,
          purchase_value_eur: 210,
          security_currency_total: 420,
          account_currency_total: 210,
          average_purchase_price_native: 0.5,
          avg_price_security: 10,
          avg_price_account: 5,
          purchase_total_security: 420,
          purchase_total_account: 210,
        },
        average_cost: {
          native: 1.2345,
          security: 3.14159,
