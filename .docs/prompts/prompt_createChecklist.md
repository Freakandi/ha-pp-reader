...
**Ziel:**
Erzeuge eine detaillierte, umsetzungsfertige ToDo-Liste für die Umsetzung/Implementierung der nächsten Entwicklungsziele, basierend auf den Festlegungen in [.docs/currency_timeseries.md](.docs/currency_timeseries.md).

**Vorgehen:**
1. Scanne das gesamte Dokument [.docs/currency_timeseries.md](.docs/currency_timeseries.md) und extrahiere alle expliziten und impliziten Anpassungspunkte (Backend, Frontend, Doku).
...
6. Die Checkliste soll als neue TODO_currency_timeseries.md im Ordner .docs abgelegt werden.
