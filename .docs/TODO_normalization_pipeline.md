1. [ ] Phase 0 – Schema & Snapshot Foundations
...
2. [ ] Phase 1 – Normalization Pipeline Module
...
3. [ ] Phase 2 – WebSocket & Event Integration
...
4. [ ] Phase 3 – Coordinator Orchestration & Feature Flags
   a) [x] Extend `custom_components/pp_reader/data/coordinator.py` to trigger normalization after metrics complete (feature flag `normalized_pipeline`), cache the resulting snapshot, and push progress events.
