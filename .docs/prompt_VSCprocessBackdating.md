...
Active checklist (exactly one per run): `.docs/TODO_backdating1_datamodel.md`

Related references:
- Concept: `.docs/wealth-backdating-concept.md`
- Implementation plan: `.docs/wealth-backdating-plan.md`
- Other backdating TODOs (for context only): `.docs/TODO_backdating_backend.md`, `.docs/TODO_backdating_api.md`, `.docs/TODO_backdating4_frontend.md`, `.docs/TODO_backdating5_testing.md`, `.docs/TODO_backdating6_documentation.md`
