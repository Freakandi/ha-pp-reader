...
1. b) [ ] `logic/portfolio.py` auf neue Helper umstellen
...
1. c) [ ] Datenbank-Zugriffe auf Helper umstellen
...
1. d) [ ] Event-Push Normalisierung vereinheitlichen
...
1. e) [ ] WebSocket Account-Payloads auf Helper migrieren
...
1. f) [ ] Preis-Service Revaluation auf Helper stützen
...
2. a) [ ] Gemeinsamen Currency-Helper für das Dashboard anlegen
...
2. b) [ ] Tabs auf gemeinsamen Helper umstellen
...
2. c) [ ] Websocket-DOM-Patcher auf numerischen Helper ausrichten
