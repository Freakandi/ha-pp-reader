...
class PortfolioPurchaseSensor(PortfolioSensor):
    ...
    def __init__(self, hass, portfolio_name: str, portfolio_uuid: str, db_path: Path):
        ...
        self._attr_unique_id = f"pp_reader_kaufsumme_{slugify(portfolio_name)}"
        self._attr_native_unit_of_measurement = "€"
        self._attr_icon = "mdi:cash"

    @property
    def native_value(self):
        return self._attr_native_value  # Verwende attr_native_value statt _purchase_sum
    ...
    async def _async_update_internal(self) -> None:
        ...
        self._purchase_sum = purchase_sum  # Für Kompatibilität
        self._attr_native_value = purchase_sum
