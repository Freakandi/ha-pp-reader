const an = /* @__PURE__ */ new Set(), on = /* @__PURE__ */ new Set(), ur = {}, ja = [
...
function hr(e) {
  ...
  const a = V(
    ...
    position_count: An(e.position_count ?? e.count) ?? void 0,
    missing_value_positions: An(e.missing_value_positions) ?? void 0,
...
function _r(e) {
  ...
  if (!t)
    return null;
  const n = Qe(e.metric_run_uuid), r = pr(e.accounts), a = mr(e.portfolios), i = ei(e.diagnostics), o = {
    generated_at: t,
    metric_run_uuid: n,
    accounts: r,
    portfolios: a
...
function ri(e) {
  const t = Nn(e.security_uuid, "security_uuid"), n = Nn(e.name, "name"), r = xt(e.current_holdings, "current_holdings"), a = xt(e.purchase_value, "purchase_value"), i = xt(e.current_value, "current_value"), o = {
    security_uuid: t,
    name: n,
    current_holdings: r,
    purchase_value: a,
...
async function ai(e, t) {
  ...
  const r = await e.connection.sendMessagePromise({
    ...
    entry_id: n
  }), a = pr(r.accounts), i = _r(r.normalized_payload);
  return {
    accounts: a,
...
async function oi(e, t) {
  ...
  const r = await e.connection.sendMessagePromise({
    ...
    entry_id: n
  }), a = mr(r.portfolios), i = _r(r.normalized_payload);
  return {
    portfolios: a,
    normalized_payload: i
  };
...
function xn(e) {
  const t = br(e), n = te(e.scope_type), r = te(e.scope_id);
...
function ci(e) {
  if (!e || typeof e != "object")
    return;
  const t = e, n = Array.isArray(t.accounts) ? t.accounts : [], r = Array.isArray(t.portfolios) ? t.portfolios : [], a = n.map((o) => o && typeof o == "object" ? xn(o) : null).filter((o) => !!o), i = r.map((o) => o && typeof o == "object" ? xn(o) : null).filter((o) => !!o);
...
async function li(e, t, n) {
  ...
  const g = await e.connection.sendMessagePromise(d), m = si(g.range, f, p), h = (Array.isArray(g.records) ? g.records : []).map((b) => b && typeof b == "object" ? br(b) : null).filter((b) => !!b), _ = ci(g.slices);
  return {
    range: m,
    records: h,
    ..._ ? { slices: _ } : {}
...
async function vr(e, t, n) {
  ...
  const a = await e.connection.sendMessagePromise({
    ...
    entry_id: r,
    portfolio_uuid: n
  }), o = gr(a.positions).map(ri), c = yr(a.normalized_payload), s = {
...
function wi(e) {
  if (!e || typeof e != "object")
    return null;
  const t = _i(e) ? Re(e) : e, n = ye(t.security_uuid), r = ye(t.name), a = fe(t.current_holdings), i = Fn(t.current_value), o = dn(t.aggregation), c = t.aggregation && typeof t.aggregation == "object" ? t.aggregation : null, s = U(t.purchase_value_eur) ?? U(c?.purchase_value_eur) ?? U(c?.purchase_total_account) ?? U(c?.account_currency_total) ?? Fn(t.purchase_value);
...
function Li(e) {
  if (!e)
    return null;
  const t = ee(e.uuid) ?? `${ki}-${e.name ?? "0"}`, n = xr(e.name, "Unbenanntes Konto"), r = ee(e.currency_code), a = Z(e.balance), i = Z(e.orig_balance), o = "coverage_ratio" in e ? Fr(Z(e.coverage_ratio)) : null, c = ee(e.provenance), s = ee(e.metric_run_uuid), l = e.fx_unavailable === !0, u = Z(e.fx_rate), f = ee(e.fx_rate_source), p = ee(e.fx_rate_timestamp), d = [], g = $r(c);
  g && d.push(g);
  const m = {
    uuid: t,
    name: n,
...
function Mi(e) {
  ...
  if (!t)
    return null;
  const n = xr(e.name, "Unbenanntes Depot"), r = $n(e.position_count), a = $n(e.missing_value_positions), i = Z(e.current_value), o = Z(e.purchase_sum) ?? Z(e.purchase_value_eur) ?? Z(e.purchase_value) ?? 0, c = Z(e.day_change_abs) ?? null, s = Z(e.day_change_pct) ?? null, l = Se(e.performance), u = l?.gain_abs ?? null, f = l?.gain_pct ?? null, p = l?.day_change ?? null;
  ...
  const m = i != null, y = e.has_current_value === !1 || !m, h = "coverage_ratio" in e ? Fr(Z(e.coverage_ratio)) : null, _ = ee(e.provenance), b = ee(e.metric_run_uuid), S = [], C = $r(_);
  C && S.push(C);
  const A = {
    uuid: t,
    name: n,
...
const Ui = 500, qi = 10, Wi = "pp-reader:portfolio-positions-updated", Oi = "pp-reader:diagnostics", Ft = /* @__PURE__ */ new Map(), Mr = [
  "coverage_ratio",
  "provenance",
  "metric_run_uuid",
  "generated_at"
...
function ao(e, t) {
  ...
  for (const [f, p] of u.entries()) {
    ...
    }, 800)), h && (h.innerHTML = L("day_change_abs", x, $, z)), _ && (_.innerHTML = L("day_change_pct", k, $, z)), b) {
...
function Hn(e, t) {
  ...
  if (f.applied) {
    ...
    r || f.reason !== "hidden" || l ? (le.set(n, { positions: u, error: r }), Ir(t, n)) : (le.delete(n), Oe.delete(n));
  if (!r && o.length > 0) {
    const p = Array.from(
      new Set(
    ...
    if (o) {
      ...
      if (u)
        ...
        o.querySelectorAll("tbody tr").forEach((p, d) => {
          ...
          if (!g)
            return;
          const m = e[d], y = Tn(m), h = typeof y?.gain_pct == "number" && Number.isFinite(y.gain_pct) ? y.gain_pct : null, _ = h != null ? `${h.toLocaleString("de-DE", {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
...
function Vr(e, t, n) {
  const r = n ?? document, i = (Array.isArray(e) ? e : []).reduce((f, p) => {
    const d = p.balance ?? p.current_value ?? p.value, g = In(d);
    return f + g;
  }, 0), c = (Array.isArray(t) ? t : []).reduce((f, p) => {
    const d = p.current_value ?? p.value, g = In(d);
    return f + g;
...
function Cc(e) {
  ...
  e.dataset.sortKey = n, e.dataset.sortDir = a, Sr(t, n, a, !0);
}
const wc = {
...
function ho(e) {
  ...
  const y = On(m, g), h = d ? null : On(f, "EUR"), _ = !!h && h !== y, b = [], S = [];
  y ? (b.push(
...
function Wr(e) {
  ...
  const t = (v) => v == null || typeof v != "string" && typeof v != "number" && typeof v != "boolean" ? "" : he(v);
  ...
  r.forEach((v) => {
    ...
    const Oa = he(v.name), Ba = Tr(Ur(v.badges), {
    ...
    n += `<td class="align-right">${Ya}</td>`, n += `<td class="align-right">${ka}</td>`, n += `<td class="align-right">${$a}</td>`, n += `<td class="align-right">${Ra}</td>`, n += `<td class="align-right">${Ta}</td>`, n += `<td class="align-right"${Dt}>${La}</td>`, n += `<td class="align-right gain-pct-cell">${Ma}</td>`, n += "</tr>", n += `<tr class="portfolio-details${ze ? "" : " hidden"}"
                data-portfolio="${v.uuid}"
                id="${wn}"
                role="region"
                aria-label="Positionen für ${v.name}">
      <td colspan="${r.length.toString()}">
        <div class="positions-container">${ze ? At(v.uuid) ? Ke(Pr(v.uuid)) : un("Lade Positionen...") : ""}</div>
      </td>
    </tr>`;
  });
  ...
  const H = String(Math.round(i)), w = f ? String(o) : "", E = f ? String(c) : "", I = d ? String(l) : "", x = d && typeof g == "number" && Number.isFinite(g) ? String(g) : "", k = f ? String(u) : "", K = f && typeof m == "number" && Number.isFinite(m) ? String(m) : "";
...
function Xe(e, t) {
  ...
  }, o = r.dataset.sortKey, c = r.dataset.sortDir, s = a.dataset.defaultSort, l = a.dataset.defaultDir, u = $t(o) ? o : $t(s) ? s : "name", f = Rt(c) ? c : Rt(l) ? l : "asc";
  i(u, f), a.addEventListener("click", (p) => {
    ...
    if (!$t(m))
      return;
    let y = "asc";
    r.dataset.sortKey === m && (y = (Rt(r.dataset.sortDir) ? r.dataset.sortDir : "asc") === "asc" ? "desc" : "asc"), r.dataset.sortKey = m, r.dataset.sortDir = y, i(m, y);
  });
}
          ...
          try {
            ...
            if (u.classList.contains("hidden")) {
              ...
              if (At(l)) {
                ...
                const d = u.querySelector(".positions-container");
                d && (d.innerHTML = un("Lade Positionen..."));
                try {
                  const g = await vr(
                    ut,
                    dt,
...
async function Br(e, t, n) {
  ...
  `, _ = ln("Übersicht", h), b = Wr(o), S = a.filter((w) => (w.currency_code ?? "EUR") === "EUR"), C = a.filter((w) => (w.currency_code ?? "EUR") !== "EUR"), P = C.some((w) => w.fx_unavailable) ? `
...
function wo(e, t) {
  ...
  const n = () => {
    try {
      ...
      i && i.querySelectorAll(".portfolio-toggle").length === 0 && (console.debug("Recovery: Tabelle ohne Buttons – erneuter Aufbau"), i.innerHTML = Wr(t)), mn(e), Co(e), ft.forEach((o) => {
        try {
          At(o) && (Xe(e, o), Ge(e, o));
        } catch (c) {
...
const Po = "http://www.w3.org/2000/svg", Ee = 640, De = 260, qe = { top: 12, right: 16, bottom: 24, left: 16 }, We = "var(--pp-reader-chart-line, #3f51b5)", Bt = "var(--pp-reader-chart-area, rgba(63, 81, 181, 0.12))", Bn = "0.75rem", Yr = "var(--pp-reader-chart-baseline, rgba(96, 125, 139, 0.75))", jr = "6 4", Ao = 1440 * 60 * 1e3;
function No(e) {
  if (e == null)
    return null;
  if (typeof e == "string")
...
}, Jr = (e, t, n) => (Number.isFinite(e) ? e : pt(e, 0) ?? 0).toLocaleString("de-DE", {
  minimumFractionDigits: 2,
  maximumFractionDigits: 2
...
function ko(e, t, n) {
  ...
  const s = e.map((x, k) => {
    const K = o(x, k), v = c(x, k), D = Kr(K, k), T = pt(v, Number.NaN);
  ...
  if (s.length === 0)
    return { points: [], range: null };
  const l = s.reduce((x, k) => Math.min(x, k.xValue), s[0].xValue), u = s.reduce((x, k) => Math.max(x, k.xValue), s[0].xValue), f = s.reduce((x, k) => Math.min(x, k.yValue), s[0].yValue), p = s.reduce((x, k) => Math.max(x, k.yValue), s[0].yValue), d = Math.max(r - i.left - i.right, 1), g = Math.max(a - i.top - i.bottom, 1), m = Number.isFinite(l) ? l : 0, y = Number.isFinite(u) ? u : m + 1, h = Number.isFinite(f) ? f : 0, _ = Number.isFinite(p) ? p : h + 1, b = pt(t.baseline?.value, null), S = b != null && Number.isFinite(b) ? Math.min(h, b) : h, C = b != null && Number.isFinite(b) ? Math.max(_, b) : _, A = Math.max(
    2,
    Math.min(
      6,
      Math.round(
  ...
  return {
    points: s.map((x) => {
      const k = w === 0 ? 0.5 : (x.xValue - m) / w, K = E === 0 ? 0.5 : (x.yValue - F) / E, v = i.left + k * d, D = i.top + (1 - K) * g;
      return {
        ...x,
        x: v,
        y: D
...
function Lt(e) {
  ...
  r.forEach((l, u) => {
    const f = Kr(l.x, u), p = pt(l.y, Number.NaN), d = Number(p);
...
function Ho(e, t) {
  ...
  const n = (a) => {
    ...
    ), t.focusLine.style.opacity = "1"), t.tooltip && (t.tooltip.innerHTML = $o(t, m), Ro(t, m, d, g));
    const h = Mo(t, p, d);
    h && t.markerTooltip ? (t.markerTooltip.innerHTML = To(t, h), Lo(t, h, d, g)) : at(t);
  }, r = () => {
    Yt(t), at(t);
  };
...
function ra(e, t = {}) {
  ...
  const g = ta(n);
  if (g.svg = r, g.areaPath = a, g.linePath = o, g.baselineLine = i, g.focusLine = c, g.focusCircle = s, g.overlay = u, g.tooltip = f, g.markerOverlay = p, g.markerLayer = l, g.markerTooltip = d, g.xAccessor = t.xAccessor ?? Gr, g.yAccessor = t.yAccessor ?? Xr, g.xFormatter = t.xFormatter ?? Zr, g.yFormatter = t.yFormatter ?? Jr, g.tooltipRenderer = t.tooltipRenderer ?? Qr, g.markerTooltipRenderer = t.markerTooltipRenderer ?? ea, g.color = t.color ?? We, g.areaColor = t.areaColor ?? Bt, g.baseline = t.baseline ?? null, g.handlersAttached = !1, g.markers = Array.isArray(t.markers) ? t.markers.slice() : [], !g.xAxis) {
  ...
  return na(g, t.width, t.height, t.margin), o.setAttribute("stroke", g.color), c.setAttribute("stroke", g.color), s.setAttribute("stroke", g.color), a.setAttribute("fill", g.areaColor), yn(n, t), Ho(n, g), n;
}
function yn(e, t = {}) {
  if (!e) {
...
function Mt(e) {
  ...
  if (t.style.left = Q(a.left), t.style.width = Q(m), t.style.top = Q(i - a.bottom + 6), t.innerHTML = "", d && m > 0) {
    ...
    zo(e, c, s, b, _).forEach(({ positionRatio: C, label: A }) => {
      const P = document.createElement("div");
  ...
  if (n.style.left = "0", n.style.width = Q(Math.max(h, 0)), n.innerHTML = "", g && y > 0) {
    const _ = Math.max(2, Math.min(6, Math.round(y / 60) || 4)), b = Vo(l, u, _), S = o;
...
const Ht = { min: 0, max: 6 }, gt = { min: 2, max: 4 }, Bo = "1Y", aa = [
  "1M",
  "6M",
  "1Y",
  "5Y",
...
}, jo = /* @__PURE__ */ new Set([0, 2]), Ko = /* @__PURE__ */ new Set([1, 3]), Go = "var(--pp-reader-chart-marker-buy, #2e7d32)", Xo = "var(--pp-reader-chart-marker-sell, #c0392b)", jn = "{TICKER}", Zo = "https://chatgpt.com/", It = {
...
function is(e) {
  if (!e)
    return null;
  const t = dn(e.aggregation), n = M(t?.purchase_total_security) ?? (t ? M(
...
function ht(e, t) {
  const n = Te(t instanceof Date ? t : /* @__PURE__ */ new Date()), r = Yo[e], a = Gn(n), i = {};
...
function yt(e, t, n = null) {
  ...
  return e.forEach((c, s) => {
    const l = typeof c.type == "number" ? c.type : Number(c.type), u = jo.has(l), f = Ko.has(l);
    if (!u && !f)
      return;
    const p = os(c.date);
    let d = M(c.price);
    ...
    g && a && g !== a && oe(o) && (d *= o);
    const y = M(c.shares), h = M(c.net_price_eur), _ = u ? "Kauf" : "Verkauf", b = y != null ? `${Sn(y)} @ ` : "", S = `${_} ${b}${pe(d)} ${m}`, C = f && h != null ? `${S} (netto ${pe(h)} EUR)` : S, A = u ? Go : Xo, P = typeof c.uuid == "string" && c.uuid.trim() || `${_}-${p.getTime().toString()}-${s.toString()}`;
    r.push({
      id: P,
      x: p.getTime(),
      y: d,
...
function ls(e, t) {
  ...
  if (n === "—")
    return '<span class="value neutral">—</span>';
  const r = vn(e, gt.max), a = t ? `&nbsp;${t}` : "";
  return `<span class="value ${r}">${n}${a}</span>`;
}
function us(e) {
  return R(e) ? `<span class="value ${vn(e, 2)} value--percentage">${re(e)}&nbsp;%</span>` : '<span class="value neutral">—</span>';
}
function ga(e, t, n, r) {
...
function vs(e, t) {
  ...
  const f = _s(e), p = bs(f), d = [`FX-Kurs (Kauf): 1 ${n} = ${l} ${c}`];
  u && d.push(`1 ${c} = ${u} ${n}`);
...
function Ss(e) {
  ...
  const t = e.currency_code || "EUR", n = e.total_holdings_precise ?? e.total_holdings, r = Sn(n), a = e.last_price_native ?? e.last_price?.native ?? e.last_price_eur, i = pe(a), o = i === "—" ? null : `${i}${`&nbsp;${t}`}`, c = M(e.market_value_eur) ?? M(e.current_value_eur) ?? null, s = Me(e.average_cost), l = s?.native ?? s?.security ?? null, u = s?.eur ?? null, p = s?.account ?? null ?? u, d = Se(e.performance), g = d?.day_change ?? null, m = g?.price_change_native ?? null, y = g?.price_change_eur ?? null, h = R(m) ? m : y, _ = R(m) ? t : "EUR", b = ($, z = "") => {
    const W = ["value"];
    ...
    if (!R($))
      return S(z);
    const W = ["value--gain"];
    return z && W.push(z), b(fi($), W.join(" "));
  }, A = ($, z = "") => {
    if (!R($))
      return S(z);
    const W = ["value--gain-percentage"];
    return z && W.push(z), b(pi($), W.join(" "));
  }, P = o ? b(o, "value--price") : S("value--price"), N = r === "—" ? S("value--holdings") : b(r, "value--holdings"), F = R(c) ? b(`${re(c)}&nbsp;€`, "value--market-value") : S("value--market-value"), H = R(h) ? b(
    fs(h, _),
  ...
  let T = null, Y = null;
  return D && (t !== "EUR" || !R(l) || !Ye(u, l)) ? (T = u, Y = "EUR") : R(p) && x && (x !== t || !Ye(p, l ?? NaN)) && (T = p, Y = x), T != null && R(T) && v.push(
    b(
      `${pe(T)}${Y ? `&nbsp;${Y}` : ""}`,
...
function ws(e, t, {
  ...
  const i = e.clientWidth || e.offsetWidth || 0, o = i > 0 ? i : 640, c = Math.min(Math.max(Math.floor(o * 0.5), 240), 440), s = (n || "").toUpperCase() || "EUR", l = R(r) ? r : null, u = Math.max(48, Math.min(72, Math.round(o * 0.075))), f = Math.max(28, Math.min(56, Math.round(o * 0.05))), p = Math.max(40, Math.min(64, Math.round(c * 0.14)));
  return {
    width: o,
    height: c,
    margin: {
    ...
    markerTooltipRenderer: ({
      ...
      const h = g.payload ?? {}, _ = da(h.type), b = M(h.shares), S = b != null ? Sn(b) : null, C = Pe(h.currency) ?? s, A = [];
...
function Ps(e, t, n = {}) {
  ...
  let a = Jn.get(e) ?? null;
  if (!a || !e.contains(a)) {
    e.innerHTML = "", a = ra(e, r), a && Jn.set(e, a);
    return;
  }
  yn(a, r);
}
...
function Ns(e) {
  ...
  setTimeout(() => {
    ...
    if (!l)
      return;
    const u = oa(a), f = sa(a), p = Zn(i);
    Array.isArray(c) && s.status !== "error" && u.set(o, c), ns(a), Kn(a, o), Qn(l, o);
    const g = Xt(
      c,
      i
    );
    ...
    const y = async (h) => {
      ...
      if (b)
        ...
        try {
          ...
          console.error("Range-Wechsel: Historie konnte nicht geladen werden", E), b = [], S = [], C = {
            status: "error",
            message: ma(E) || "Die historischen Daten konnten aufgrund eines Fehlers nicht geladen werden."
          };
        }
      if (!Array.isArray(S))
        try {
      ...
      const P = bn(i), { priceChange: N, priceChangePct: F } = pa(
        A,
        P
      ), H = Array.isArray(S) ? S : [];
      Kn(a, h), Qn(l, h), As(
...
function Es(e) {
  ...
  c(), setTimeout(() => {
    ...
    if (!s)
      return;
    const l = (f) => {
      const p = (i?.placeholder || jn).trim() || jn, d = (i?.prompt_template || "").trim(), g = (i?.link || "").trim() || Zo;
...
Ticker: ${f}` : `Ticker: ${f}`, link: g };
      ...
      try {
        const { body: d, link: g } = l(f), m = await hs(d);
        m ? s.textContent = "✅ Copied! Opening..." : console.warn("News-Prompt: Clipboard unavailable – prompt could not be copied"), m && await new Promise((y) => setTimeout(y, 800)), ms(g), !i && !o && c();
      } catch (d) {
...
async function Ds(e, t, n, r) {
  ...
  r && Qo(r, c ?? null);
  const u = c && (s || l) ? Jo({ fallbackUsed: s, flaggedAsCache: l }) : "", f = c?.name || "Wertpapierdetails", p = ln(f, "", { includeMeta: !1 });
  ...
  const C = ps(c, r), A = gs(C), P = bn(c), { priceChange: N, priceChangePct: F } = pa(
    S,
    P
  ), H = ga(
    g,
...
function Rs(e) {
  const t = Zt(e.date ?? null), n = $s(e.range ?? null);
  if (t && n)
...
function ba(e, t) {
  ...
  let c = o;
  !o.__chartState || !n.querySelector("svg") ? (n.innerHTML = "", c = ra(n, i)) : (yn(o, i), c = o), c && Ks(c, r);
}
function Gs(e) {
  if (!e.length)
    return null;
...
async function or(e, t, n, r, a) {
  ...
  ya = a, Qt = o, Os(o.slices);
  const c = a.range ? `Zeitraum: ${a.range.start} – ${a.range.end}` : a.date ? `Tag: ${a.date}` : "";
  ar(e, c, o.records), ir(e, o.records), t && (Bs(t, o.slices), ba(t, o)), et(e, "loaded");
}
function Xs(e, t, n, r) {
  const a = e.querySelector("#analyse-date-picker-container"), i = ya ?? Jt().selection ?? qs();
  let o;
  if (i.range)
    o = {
...
const Js = uo, en = "pp-reader-sticky-anchor", vt = "overview", Qs = "analyse", tn = "security:", ec = [
  { key: vt, title: "Dashboard", render: Br },
  { key: Qs, title: "Zeitmaschine", render: Zs }
], Le = /* @__PURE__ */ new Map(), Je = [], St = /* @__PURE__ */ new Map();
let nn = null, Vt = !1, ke = null, q = 0, Ut = null;
function Ct(e) {
  return typeof e == "object" && e !== null;
}
function va(e) {
...
async function sc(e, t, n, r) {
  ...
  Ca();
  const o = q >= 0 && q < a.length ? a[q] : null, c = o ? Cn(o.key) : null;
  let s = i;
  if (c) {
    const l = i >= 0 && i < a.length ? a[i] : null;
    if (l && l.key === vt && fc(c, { suppressRender: !0 })) {
...
function Aa(e) {
  ...
  if (!n && typeof nn == "function")
    try {
      const i = nn(e);
      i && typeof i.render == "function" ? (cc(t, i), n = lr(t)) : console.error("openSecurityDetail: Factory lieferte ungültigen Descriptor", i);
    } catch (i) {
  ...
  return a === -1 && (a = ue().findIndex((o) => o.key === t), a === -1) ? (console.error("openSecurityDetail: Tab nach Registrierung nicht auffindbar"), !1) : (q = a, ke = null, rn(), !0);
}
function fc(e, t = {}) {
  if (!e)
...
async function Na(e, t, n) {
  ...
  try {
    ...
    console.error("renderTab: Fehler beim Rendern des Tabs:", u), e.innerHTML = `<div class="card"><h2>Fehler</h2><pre>${tc(u)}</pre></div>`;
    return;
  }
  e.innerHTML = o ?? "", i.render === Br && mn(e);
...
class yc extends HTMLElement {
  ...
  _checkInitialization() {
    ...
    const t = En(this._hass, this._panel);
    if (!t) {
  ...
  _handleBusEvent(t) {
    const n = En(this._hass, this._panel);
    if (!n)
      return;
    const r = t.data;
