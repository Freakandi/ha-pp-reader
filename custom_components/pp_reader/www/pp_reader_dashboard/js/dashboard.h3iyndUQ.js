...
function we(e) {
  ...
  if (n == null || r == null || a == null || i == null)
    return null;
  const o = Cr(t.source) ?? "derived", c = ce(t.coverage_ratio) ?? null, s = bi(t.day_change);
  return {
    gain_abs: n,
    gain_pct: r,
    total_change_eur: a,
...
function Fi(e) {
  ...
  for (const n of t) {
    ...
    if (!r)
      continue;
    const a = Se.get(r.uuid), i = a ? Ni(a, r) : pn(r);
    Se.set(i.uuid, i);
  }
}
function lt(e, t) {
...
function Ti(e) {
  ...
  if (!t.startsWith("{") && !t.startsWith("["))
    return null;
  try {
    const n = JSON.parse(t), r = Li(n), a = n && typeof n == "object" ? te(
      n.provider ?? n.source
    ) : null;
    if (r.length && a)
      return `${kr(a)} (${r.join(", ")})`;
...
function Mi(e) {
  if (!e)
    return null;
  const t = te(e.uuid) ?? `${$i}-${e.name ?? "0"}`, n = Dr(e.name, "Unbenanntes Konto"), r = te(e.currency_code), a = J(e.balance), i = J(e.orig_balance), o = "coverage_ratio" in e ? Fr(J(e.coverage_ratio)) : null, c = te(e.provenance), s = te(e.metric_run_uuid), l = e.fx_unavailable === !0, d = J(e.fx_rate), f = te(e.fx_rate_source), p = te(e.fx_rate_timestamp), u = [], g = $r(c);
  g && u.push(g);
  const m = {
    uuid: t,
    name: n,
...
const qi = 500, Wi = 10, Oi = "pp-reader:portfolio-positions-updated", Bi = "pp-reader:diagnostics", kt = /* @__PURE__ */ new Map(), Mr = [
  "coverage_ratio",
  "provenance",
  "metric_run_uuid",
  "generated_at"
...
function Mn(e) {
  if (Object.keys(e.changed).length) {
    ...
    if (!(typeof window > "u" || typeof window.dispatchEvent != "function"))
      try {
        window.dispatchEvent(new CustomEvent(Bi, { detail: e }));
      } catch (t) {
...
function Hr(e, t, n, r) {
  ...
  return i.innerHTML = zr(n), o && (i.dataset.sortKey = o), c && (i.dataset.sortDir = c), eo(i, e, t), { applied: !0 };
}
function mn(e, t) {
  const n = ue.get(t);
  if (!n) return !1;
...
function Ir(e, t) {
  ...
  n.timer || (n.timer = setTimeout(() => {
    ...
    const r = mn(e, t);
    r || n.attempts >= Wi ? (Be.delete(t), r || ue.delete(t)) : Ir(e, t);
  }, qi), Be.set(t, n));
}
function no(e, t) {
...
function io(e, t) {
  ...
  for (const [f, p] of d.entries()) {
    ...
    if (!g || !m || !h)
      continue;
    const C = typeof p.position_count == "number" && Number.isFinite(p.position_count) ? p.position_count : 0, A = typeof p.current_value == "number" && Number.isFinite(p.current_value) ? p.current_value : null, P = we(p.performance), N = typeof P?.gain_abs == "number" ? P.gain_abs : null, F = typeof P?.gain_pct == "number" ? P.gain_pct : null, I = typeof p.purchase_sum == "number" && Number.isFinite(p.purchase_sum) ? p.purchase_sum : typeof p.purchase_value == "number" && Number.isFinite(p.purchase_value) ? p.purchase_value : null, w = P?.day_change ?? null, x = Ne(p.day_change_abs) ?? Ne(w?.value_change_eur) ?? Ne(w?.price_change_eur), U = Ne(p.day_change_pct) ?? Ne(w?.change_pct);
    let E = x ?? null, $ = U ?? null;
  ...
  try {
    ...
    if (o) {
      ...
      c.forEach((f, p) => {
        ...
        f.setAttribute("aria-label", `${k(g)} sortieren`);
...
function Ge(e) {
  ...
  const t = [
    ...
    const i = we(a.performance), o = typeof i?.gain_abs == "number" ? i.gain_abs : null, c = typeof i?.gain_pct == "number" ? i.gain_pct : null, s = yo(a), l = typeof a.purchase_value == "number" || typeof a.purchase_value == "string" ? a.purchase_value : null;
    return {
      name: typeof a.name == "string" ? k(a.name) : typeof a.name == "number" ? String(a.name) : "",
  ...
  try {
    ...
    if (i) {
      ...
      return t.forEach((s, l) => {
        ...
        d.setAttribute("aria-label", `${k(f)} sortieren`);
        ...
        if (p) {
          const { markup: m, sortValue: h, ariaLabel: y } = mo(d);
...
function Wr(e) {
  ...
  r.forEach((S) => {
    ...
    const D = Number.isFinite(S.position_count) ? S.position_count : 0, L = Number.isFinite(S.purchase_sum) ? S.purchase_sum : 0, j = S.hasValue && typeof S.current_value == "number" && Number.isFinite(S.current_value) ? S.current_value : null, R = j !== null, z = S.performance, O = typeof S.gain_abs == "number" ? S.gain_abs : typeof z?.gain_abs == "number" ? z.gain_abs : null, Y = typeof S.gain_pct == "number" ? S.gain_pct : typeof z?.gain_pct == "number" ? z.gain_pct : null, X = z && typeof z == "object" ? z.day_change : null, G = typeof S.day_change_abs == "number" ? S.day_change_abs : X && typeof X == "object" ? X.value_change_eur ?? X.price_change_eur : null, ze = typeof S.day_change_pct == "number" ? S.day_change_pct : X && typeof X == "object" && typeof X.change_pct == "number" ? X.change_pct : null, Ce = S.fx_unavailable && R, Na = typeof S.coverage_ratio == "number" && Number.isFinite(S.coverage_ratio) ? S.coverage_ratio : "", xa = typeof S.provenance == "string" ? S.provenance : "", Da = typeof S.metric_run_uuid == "string" ? S.metric_run_uuid : "", Ve = pt.has(S.uuid), Fa = Ve ? "portfolio-toggle expanded" : "portfolio-toggle", An = `portfolio-details-${S.uuid}`, Q = {
      ...
      gain_abs: O,
      gain_pct: Y
    }, Ee = { hasValue: R }, ka = M("purchase_value", Q.purchase_value, Q, Ee), $a = M("current_value", Q.current_value, Q, Ee), Ra = M("day_change_abs", Q.day_change_abs, Q, Ee), Ta = M("day_change_pct", Q.day_change_pct, Q, Ee), La = M("gain_abs", Q.gain_abs, Q, Ee), Ma = M("gain_pct", Q.gain_pct, Q, Ee), Pn = R && typeof Y == "number" && Number.isFinite(Y) ? `${ae(Y)} %` : "", Ha = R && typeof Y == "number" && Number.isFinite(Y) ? Y > 0 ? "positive" : Y < 0 ? "negative" : "neutral" : "", Ia = R && typeof j == "number" && Number.isFinite(j) ? j : "", za = R && typeof O == "number" && Number.isFinite(O) ? O : "", Va = R && typeof Y == "number" && Number.isFinite(Y) ? Y : "", Ua = R && typeof G == "number" && Number.isFinite(G) ? G : "", qa = R && typeof ze == "number" && Number.isFinite(ze) ? ze : "", Wa = String(D);
    let Dt = "";
    ...
    const Oa = k(S.name), Ba = Tr(Ur(S.badges), {
  ...
  const i = (u, g) => {
    ...
    h.sort((v, C) => {
      const P = {
        ...
        gain_abs: 7,
        gain_pct: 8
      }[u], N = v.cells.item(P), F = C.cells.item(P);
      let I = "";
      if (N) {
            ...
            if (d.classList.contains("hidden")) {
              ...
              if (Et(l)) {
                ...
                try {
                  ...
                  h && (h.innerHTML = `<div class="error">Fehler beim Laden: ${k(m)} <button class="retry-pos" data-portfolio="${l}">Retry</button></div>`), console.error("Fehler beim Lazy Load für", l, g);
                }
              }
            } else
...
const Po = "http://www.w3.org/2000/svg", xe = 640, De = 260, We = { top: 12, right: 16, bottom: 24, left: 16 }, Oe = "var(--pp-reader-chart-line, #3f51b5)", Yt = "var(--pp-reader-chart-area, rgba(63, 81, 181, 0.12))", Yn = "0.75rem", Yr = "var(--pp-reader-chart-baseline, rgba(96, 125, 139, 0.75))", jr = "6 4", Eo = 1440 * 60 * 1e3;
function No(e) {
  if (e == null)
    return null;
  if (typeof e == "string")
...
function $o(e, t, n) {
  ...
  ), { niceMin: P, niceMax: N } = zo(
    v,
    C,
    A
  ), F = Number.isFinite(P) ? P : y, I = Number.isFinite(N) ? N : _, w = h - m || 1, x = I - F || 1;
  return {
    points: s.map((E) => {
      const $ = w === 0 ? 0.5 : (E.xValue - m) / w, K = x === 0 ? 0.5 : (E.yValue - F) / x, S = i.left + $ * u, D = i.top + (1 - K) * g;
      return {
        ...E,
        x: S,
        y: D
...
function Mo(e, t, n, r = null) {
  ...
  const F = ee(Math.round(m)), I = ee(Math.round(N));
...
function Io(e, t) {
  ...
  const n = (a) => {
    ...
    ), t.focusLine.style.opacity = "1"), t.tooltip && (t.tooltip.innerHTML = Ro(t, m), To(t, m, u, g));
    const y = Ho(t, p, u);
    y && t.markerTooltip ? (t.markerTooltip.innerHTML = Lo(t, y), Mo(t, y, u, g)) : it(t);
  }, r = () => {
    jt(t), it(t);
  };
...
function ra(e, t = {}) {
  ...
  return na(g, t.width, t.height, t.margin), o.setAttribute("stroke", g.color), c.setAttribute("stroke", g.color), s.setAttribute("stroke", g.color), a.setAttribute("fill", g.areaColor), bn(n, t), Io(n, g), n;
}
function bn(e, t = {}) {
  if (!e) {
...
function Ht(e) {
  ...
  if (t.style.left = ee(a.left), t.style.width = ee(m), t.style.top = ee(i - a.bottom + 6), t.innerHTML = "", u && m > 0) {
    const _ = (s - c) / Eo, b = Math.max(2, Math.min(6, Math.round(m / 140) || 4));
    Vo(e, c, s, b, _).forEach(({ positionRatio: C, label: A }) => {
      const P = document.createElement("div");
      P.className = "line-chart-axis-tick line-chart-axis-tick-x", P.style.position = "absolute", P.style.bottom = "0";
      const N = re(C, 0, 1);
      P.style.left = ee(N * m);
      let F = "-50%", I = "center";
      N <= 1e-3 ? (F = "0", I = "left", P.style.marginLeft = "2px") : N >= 0.999 && (F = "-100%", I = "right", P.style.marginRight = "2px"), P.style.transform = `translateX(${F})`, P.style.textAlign = I, P.textContent = A, t.appendChild(P);
    });
  }
  ...
  if (n.style.left = "0", n.style.width = ee(Math.max(y, 0)), n.innerHTML = "", g && h > 0) {
    const _ = Math.max(2, Math.min(6, Math.round(h / 60) || 4)), b = Uo(l, d, _), v = o;
    b.forEach(({ value: C, positionRatio: A }) => {
      ...
      P.style.top = ee(F), P.textContent = v(C, null, -1), n.appendChild(P);
    });
  }
}
function zo(e, t, n = 4) {
...
function Bo(e) {
  return e instanceof CustomEvent ? Oo(e.detail) : !1;
}
const It = { min: 0, max: 6 }, ht = { min: 2, max: 4 }, Yo = "1Y", aa = [
  "1M",
  "6M",
  "1Y",
  "5Y",
...
}, Ko = /* @__PURE__ */ new Set([0, 2]), Go = /* @__PURE__ */ new Set([1, 3]), Xo = "var(--pp-reader-chart-marker-buy, #2e7d32)", Zo = "var(--pp-reader-chart-marker-sell, #c0392b)", Kn = "{TICKER}", Jo = "https://chatgpt.com/", zt = {
...
function mt(e, t) {
  const n = Le(t instanceof Date ? t : /* @__PURE__ */ new Date()), r = jo[e], a = Xn(n), i = {};
...
function bt(e, t, n = null) {
  ...
  return e.forEach((c, s) => {
    const l = typeof c.type == "number" ? c.type : Number(c.type), d = Ko.has(l), f = Go.has(l);
    if (!d && !f)
      return;
    const p = ss(c.date);
    let u = H(c.price);
    ...
    g && a && g !== a && se(o) && (u *= o);
    const h = H(c.shares), y = H(c.net_price_eur), _ = d ? "Kauf" : "Verkauf", b = h != null ? `${wn(h)} @ ` : "", v = `${_} ${b}${he(u)} ${m}`, C = f && y != null ? `${v} (netto ${he(y)} EUR)` : v, A = d ? Xo : Zo, P = typeof c.uuid == "string" && c.uuid.trim() || `${_}-${p.getTime().toString()}-${s.toString()}`;
    r.push({
      id: P,
      x: p.getTime(),
      y: u,
...
function ls(e, t) {
  return !T(t) || t === 0 || !T(e) ? null : mi((e - t) / t * 100);
}
function pa(e, t) {
  if (e.length === 0)
...
function Ss(e, t) {
  ...
  const f = _s(e), p = vs(f), u = [`FX-Kurs (Kauf): 1 ${n} = ${l} ${c}`];
  d && u.push(`1 ${c} = ${d} ${n}`);
...
function ws(e) {
  ...
  const t = e.currency_code || "EUR", n = e.total_holdings_precise ?? e.total_holdings, r = wn(n), a = e.last_price_native ?? e.last_price?.native ?? e.last_price_eur, i = he(a), o = i === "—" ? null : `${i}${`&nbsp;${k(t)}`}`, c = H(e.market_value_eur) ?? H(e.current_value_eur) ?? null, s = He(e.average_cost), l = s?.native ?? s?.security ?? null, d = s?.eur ?? null, p = s?.account ?? null ?? d, u = we(e.performance), g = u?.day_change ?? null, m = g?.price_change_native ?? null, h = g?.price_change_eur ?? null, y = T(m) ? m : h, _ = T(m) ? t : "EUR", b = (R, z = "") => {
    const O = ["value"];
    ...
    if (!T(R))
      return v(z);
    const O = ["value--gain"];
    return z && O.push(z), b(fi(R), O.join(" "));
  }, A = (R, z = "") => {
    if (!T(R))
      return v(z);
    const O = ["value--gain-percentage"];
    return z && O.push(z), b(pi(R), O.join(" "));
  }, P = o ? b(o, "value--price") : v("value--price"), N = r === "—" ? v("value--holdings") : b(r, "value--holdings"), F = T(c) ? b(`${ae(c)}&nbsp;€`, "value--market-value") : v("value--market-value"), I = T(y) ? b(
    ps(y, _),
...
function As(e, t, {
  ...
  return {
    ...
    markerTooltipRenderer: ({
      ...
      const P = A.join(" ").trim() || (typeof g.label == "string" ? g.label : m), N = typeof h == "string" && h.trim() ? h.trim() : he(y.price), F = N ? `${N}${C ? `&nbsp;${k(C)}` : ""}` : k(C);
      return `
...
function Ns(e) {
  ...
  setTimeout(() => {
    ...
    Array.isArray(c) && s.status !== "error" && d.set(o, c), rs(a), Gn(a, o), er(l, o);
    const g = Zt(
      c,
      i
    );
    ...
    const h = async (y) => {
      ...
      _ && (_.disabled = !0, _.classList.add("loading"), _.innerHTML = gi());
...
function xs(e) {
  ...
  c(), setTimeout(() => {
    ...
    if (!s)
      return;
    const l = (f) => {
      const p = (i?.placeholder || Kn).trim() || Kn, u = (i?.prompt_template || "").trim(), g = (i?.link || "").trim() || Jo;
...
Ticker: ${f}` : `Ticker: ${f}`, link: g };
      ...
      try {
        const { body: u, link: g } = l(f), m = await ms(u);
        m ? s.textContent = "✅ Copied! Opening..." : console.warn("News-Prompt: Clipboard unavailable – prompt could not be copied"), m && await new Promise((h) => setTimeout(h, 800)), ys(g), !i && !o && c();
      } catch (u) {
...
async function Ds(e, t, n, r) {
  ...
  r && es(r, c ?? null);
  const d = c && (s || l) ? Qo({ fallbackUsed: s, flaggedAsCache: l }) : "", f = c?.name || "Wertpapierdetails", p = un(f, "", { includeMeta: !1 });
  ...
  const C = gs(c, r), A = hs(C), P = vn(c), { priceChange: N, priceChangePct: F } = pa(
    v,
    P
  ), I = ga(
    g,
...
function Ts(e) {
  const t = Jt(e.date ?? null), n = Rs(e.range ?? null);
  if (t && n)
...
function ir(e, t, n) {
  ...
  r.innerHTML = ba(o.total_wealth_eur), a.innerHTML = Os(n);
}
function or(e, t) {
...
function Ys(e, t) {
  ...
  const o = (c, s, l) => {
    ...
    const f = Array.from(d.values()).map((p) => {
      ...
      if (!u)
        return "";
      const g = fe.has(u) ? "checked" : "", m = k(p.scope_name ?? p.scope_id);
      return `
...
function _a(e, t) {
  ...
  let c = o;
  !o.__chartState || !n.querySelector("svg") ? (n.innerHTML = "", c = ra(n, i)) : (bn(o, i), c = o), c && Gs(c, r);
}
function Xs(e) {
  if (!e.length)
    return null;
...
async function sr(e, t, n, r, a) {
  ...
  ya = a, en = o, Bs(o.slices);
  const c = a.range ? `Zeitraum: ${a.range.start} – ${a.range.end}` : a.date ? `Tag: ${a.date}` : "";
  ir(e, c, o.records), or(e, o.records), t && (Ys(t, o.slices), _a(t, o)), tt(e, "loaded");
}
function Zs(e, t, n, r) {
  const a = e.querySelector("#analyse-date-picker-container"), i = ya ?? Qt().selection ?? Ws();
  let o;
  if (i.range)
    o = {
...
const Qs = fo, tn = "pp-reader-sticky-anchor", St = "overview", ec = "analyse", nn = "security:", tc = [
  { key: St, title: "Dashboard", render: Br },
  { key: ec, title: "Zeitmaschine", render: Js }
...
async function Ea(e, t, n) {
  ...
  try {
    ...
    console.error("renderTab: Fehler beim Rendern des Tabs:", d), e.innerHTML = `<div class="card"><h2>Fehler</h2><pre>${nc(d)}</pre></div>`;
    return;
  }
...
//# sourceMappingURL=dashboard.h3iyndUQ.js.map
