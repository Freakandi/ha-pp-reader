...
| Footer metadata card | `last_file_update` | `last_file_update.ingested_at` | The footer pulls the latest import timestamp and shows a fallback label when the fetch fails.【F:src/tabs/overview.ts†L1399-L1425】 |
